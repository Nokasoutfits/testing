...
exports.signupController = async (req, res) => {
  const { userName, fullName, email, initialPlan, password, referrer } =
    req.body;
  ...
  try {
    ...
    newUser.email = email;
    newUser.initialPlan = initialPlan;
    ...
    const message = `
    <h1>Welcome!! its nice to have you onboard ${userName} </h1>
